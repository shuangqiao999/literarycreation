...
class ProseRenderer:
    ...
    async def render_chapter(
        ...
        *,
        ...
        try:
            from literarycreation.core.llm_client import Message
            text = await _retry_prose(self._client, prompt, prev_tail, target_words, chapter_idx)
            return text
